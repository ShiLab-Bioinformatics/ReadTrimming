...
Adapter_base_proportion = (Adapter_but_no_CommonCliTri + Common_CliTri_also_Adapter)*1./Total_Raw_Bases
Softclipped_adapter_bases_proportion = Common_CliTri_also_Adapter*1. / ( Common_CliTri_also_Adapter + Adapter_but_no_CommonCliTri )

print( "%.5f,%.5f;"%( Adapter_base_proportion, Softclipped_adapter_bases_proportion ) )
